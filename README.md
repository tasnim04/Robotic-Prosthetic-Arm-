...
Version 1.0 of this prototype utilises 5 servo motors to actutate the fingers. The forearm houses all the servos. Nylon wires act as tendons. The nylon wires are tied firmly to the servogear heads, and the rotation of the servos allowed the fingers to move. To find a detailed outline on how to assemble the nylon wires, check out the Assembly Guide pdf file. SolidWork and STL files are also available for download. 
...
Version 1.0 was inspired by the open-source inMoov hand created by Langevin Gael (https://inmoov.fr/) and the open-source 3D-printed prosthetic arm created by Mahdi Design (check out his YouTube channel here: https://www.youtube.com/channel/UCGLXjNTLto9N5KgInF4aDbg)
